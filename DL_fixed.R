    ...
    tryCatch(
      {
        ...
        h2o.saveModel(model, "C:\\Users\\utente\\Documents\\PUN\\fixed\\models", force = TRUE)
    ...
    tryCatch(
      {
        ...
        h2o.saveModel(model, "C:\\Users\\utente\\Documents\\PUN\\fixed\\2016\\models", force = TRUE)
        ...
        xlsx::write.xlsx(data.frame(diff),paste0("C:\\Users\\utente\\Documents\\PUN\\fixed\\2016\\errors\\distribution_errors_dayahead_",da,".xlsx"))
        ###############################################
...
xlsx::write.xlsx(res,"performance_DLFixed_AVmodels.xlsx", row.names = TRUE, col.names = TRUE)
write.table(as.data.frame(missed), "missed_AVmodels.txt")
